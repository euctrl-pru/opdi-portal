...
|-----------------|---------------|--------------------|---------------|
| `FLIGHT`        | Flight list   | [OSN]/[PRC]        | [Link][404]   |
| `EVENT`         | Flight events | [OSN]/[PRC]        | [Link][404]   |
| `MEASUREMENT`   | Measurements  | [OSN]/[PRC]        | [Link][404]   |
| `AIRPORT`       | Airports      | [OurAirports][OA]  | [Link][OAapt] |
| `RUNWAY`        | Runways       | [OurAirports][OA]  | [Link][OArwy] |
...
We intend to make it available for easy download, see [Roadmap](roadmap.html) page.
:::
