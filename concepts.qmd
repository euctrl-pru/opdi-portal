...
* **T01** = time of maintenance completion
* **T02** = time aircraft servicing begins
* **T03** = time aircraft loading begins
* **T04** = time aircraft is ready for pushback
* **T06** = time off-blocks
* **T08** = pushback complete - parking position vacated - start taxi
* **T09** = start taxi onto take-off runway
* **T10** = start take-off roll
* **T11** = start rotation
* **T12** = positive rate of climb established
* **T13** = time aircraft reaches safety altitude and leaves traffic circuit
* **T14** = time aircraft enters en-route airspace
* **T15** = time of Top of Climb
* **T18** = time of Top of Descent
* **T19** = aircraft enters terminal airspace and starts approach
* **T20** = aircraft established on final approach
* **T21** = aircraft over runway threshold
* **T22** = time of touchdown
* **T23** = time aircraft starts turn-off
* **T24** = time runway is vacated
* **T25** = aircraft starts manoeuvring into parking position
* **T27** = on-blocks
* **T29** = time unloading begins
* **T30** = unloading completed
* **T31** = arrival servicing completed
* **T32** = start of maintenance
...
(@) Off-block (**T06**)
(@) End of push back (**T08**)
(@) Enter runway for take-off (**T09**)
(@) Lift-off (**T11**), a.k.a. take-off
(@) 40-nautical-miles intersection (sort of **T14**)
(@) Top-of-climb (**T15**)
(@) Top-of-descent (**T18**)
(@) 40-nautical-miles intersection (sort of **T19**)
(@) Touch-down (**T22**)
(@) Runway vacated (**T24**)
(@) Enter parking spot (**T25**)
(@) On-block (**T27**)
...
* Taxi-in (`T24`, `T27`) time and taxi-out (`T06`, `T09`): duration of the taxi phase.
* \acr{RWY} utilization (`T09`--`T11` and  `T22`--`T24`) and sequencing.
...
An example of this is the cumulative flown distance or the emitted CO2.
